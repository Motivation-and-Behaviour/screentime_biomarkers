...
These findings were robust in two sensitivity analyses (see supplementary materials): one replacing the latent intercept with the observed Wave 3 screen-time value as the exposure, and one re-estimating the trajectories using a conventional `lme4` random intercept/random slope mixed model.
